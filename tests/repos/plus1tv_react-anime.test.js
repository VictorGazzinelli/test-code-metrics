...
describe('plus1tv_react-anime', () => {
    it('plus1tv_react-anime\\tests\\basic.tsx', () => {
        const sourceCode = `
    ...
    it('plus1tv_react-anime\\tests\\custom-components.tsx', () => {
        const sourceCode = `
			import '@testing-library/jest-dom';
    ...
    it('plus1tv_react-anime\\tests\\dynamic-list.tsx', () => {
        const sourceCode = `
    ...
    it('plus1tv_react-anime\\tests\\svg-paths.tsx', () => {
        const sourceCode = `
			import \{ render \} from '@testing-library/react';
			import Anime from '../src/react-anime';
