...
describe('hyperfuse_react-anime', () => {
    it('hyperfuse_react-anime\\__tests__\\react-anime.test.js', () => {
        const sourceCode = `
		...
		const tests = extractFromSource(sourceCode, 'hyperfuse_react-anime\\__tests__\\react-anime.test.js')
